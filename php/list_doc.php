...
$query = "SELECT * FROM docente ORDER BY nom ASC LIMIT $init, $limit";
$res = $db->query($query);
    ...
    <div class="container-fluid">
      <div class="row d-flex d-md-block flex-nowrap wrapper">
        ...
        <div class="justify-content-md-center p-3 p-md-5 m-md-3 text-center">
          <h4>Listado completo de docentes</h4>
          <div class="row">
            <div class="col">
            <?php if($res->num_rows): ?>
                ...
                <?php while($row = $res->fetch_assoc()): ?>
                  <tr>
                    ...
                    <td class="text-capitalize"><?php echo $row['tlf'] ?></td>
                    <td>
                      <button id="del_doc" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="bottom" title="Eliminar del sistema" value="<?php echo $row['ced'] ?>">
                        <span class="oi oi-ban"></span>
                      </button>
                      <button id="upd_doc" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="bottom" title="Editar datos" value="<?php echo $row['ced'] ?>">
            ...
            <?php else: ?>
            	<div class="alert alert-success" role="alert">
        			  ...
        			  <p>
        			  	No hay docentes registrados en la base de datos del comedor.
        			  </p>
        			</div>
            <?php endif; ?>
            </div>
