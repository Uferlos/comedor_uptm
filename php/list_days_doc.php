...
$query = "SELECT docente.nom, docente.ape, docente.ced, registroC.dias FROM docente INNER JOIN registroC ON docente.ced = registroC.ced ORDER BY docente.nom ASC LIMIT $init, $limit";
$res = $db->query($query);
        ...
        <div class="justify-content-md-center p-3 p-md-5 m-md-3 text-center">
          ...
          <div class="row">
            ...
            <?php if($res->num_rows): ?>
                ...
                <?php 
                  endwhile;
                  $squery = "SELECT docente.nom, docente.ape, docente.ced, registroC.dias FROM docente INNER JOIN registroC ON docente.ced = registroC.ced ORDER BY docente.nom";
