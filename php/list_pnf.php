...
$query = "SELECT * FROM pnf ORDER BY nom ASC LIMIT $init, $limit";
$res = $db->query($query);
          ...
          <div class="row">
              ...
              <table class="table table-bordered">
                ...
                <?php while($row = $res->fetch_assoc()): ?>
                  <tr>
                    ...
                    <td class="text-capitalize"><?php echo $row['cterm'] ?></td>
                    <td>
                      <button id="del_pnf" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="bottom" title="Eliminar del sistema" value="<?php echo $row['id'] ?>">
                        <span class="oi oi-ban"></span>
                      </button>
                      <button id="upd_pnf" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="bottom" title="Editar datos" value="<?php echo $row['id'] ?>">
            ...
            <?php else: ?>
              <div class="alert alert-success" role="alert">
                <h4 class="alert-heading">¡Registro de PNF vacio!</h4>
                <p>
                  No hay ningun PNF registrado en la base de datos.
                </p>
              </div>
            <?php endif; ?>
            </div>
