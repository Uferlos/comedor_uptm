...
$query = "SELECT estudiante.nombre, estudiante.apellido, estudiante.carrera, estudiante.carnet, registro.dias FROM estudiante INNER JOIN registro ON estudiante.carnet = registro.carnet ORDER BY estudiante.nombre ASC LIMIT $init, $limit";
$res = $db->query($query);
    ...
    <div class="container-fluid">
      <div class="row d-flex d-md-block flex-nowrap wrapper">
        ...
        <div class="justify-content-md-center p-3 p-md-5 m-md-3 text-center">
          <h4>Listado de usuarios del comedor</h4>
          <div class="row">
            <div class="col">
            <?php if($res->num_rows): ?>
                ...
                <?php while($row = $res->fetch_assoc()): ?>
                  <tr>
                    ...
                    <td class="text-capitalize"><?php echo $row['dias'] ?></td>
                    <td>
                      <button id="edt_esD" class="btn btn-sm btn-info" data-toggle="tooltip" data-placement="bottom" title="Actualizar días del servicio" value="<?php echo $row['carnet'] ?>">
                ...
                <?php 
                  endwhile;
                  $squery = "SELECT estudiante.nombre, estudiante.apellido, estudiante.carrera, estudiante.carnet, registro.dias FROM estudiante INNER JOIN registro ON estudiante.carnet = registro.carnet ORDER BY estudiante.nombre";
            ...
            <?php else: ?>
            	<div class="alert alert-success" role="alert">
        			  ...
        			  <p>
        			  	No hay estudiantes registrados en la base de datos del comedor.
        			  </p>
        			</div>
            <?php endif; ?>
            </div>
