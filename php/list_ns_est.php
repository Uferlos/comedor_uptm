...
$query = "SELECT * FROM estudiante WHERE carnet LIKE '%$carnet%' AND reg = 'no' ORDER BY nombre ASC LIMIT $init, $limit";
    ...
    <div class="container-fluid">
      <div class="row d-flex d-md-block flex-nowrap wrapper">
        ...
        <div class="justify-content-md-center p-3 p-md-5 m-md-3 text-center">
          <h4>Listado de estudiantes NO registrados en el comedor</h4>
          <div class="row">
            <div class="col">
            <?php if($res->num_rows): ?>
              <table class="table table-bordered">
                ...
                <?php 
                  endwhile;
                  $squery = "SELECT estudiante.carnet, estudiante.nombre, estudiante.apellido, estudiante.cedula, estudiante.carrera, estudiante.trayecto FROM estudiante WHERE estudiante.carnet LIKE '%$carnet%' ORDER BY estudiante.nombre ASC";
            ...
            <?php else: ?>
              <div class="alert alert-success" role="alert">
                ...
                <p>
                  No hay estudiantes sin servicio de comedor en la base de datos.
                </p>
              </div>
            <?php endif; ?>
            </div>
