...
$query = "SELECT * FROM estudiante WHERE carrera = 'informatica' ORDER BY nombre ASC LIMIT $init, $limit";
$res = $db->query($query);
        ...
        <div class="justify-content-md-center p-3 p-md-5 m-md-3 text-center">
          <div class="row">
            ...
            <?php if($res->num_rows): ?>
                ...
                <?php 
                  endwhile;
                  $squery = "SELECT * FROM estudiante WHERE carrera = 'informatica'";
            ...
            <?php else: ?>
            	<div class="alert alert-success" role="alert">
        			  ...
        			  <p>
        			  	No hay estudiantes de informatica registrados en la base de datos del comedor.
        			  </p>
        			</div>
            <?php endif; ?>
            </div>
