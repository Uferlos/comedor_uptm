...
$query = "SELECT * FROM inventario ORDER BY nom ASC LIMIT $init, $limit";
$res = $db->query($query);
    ...
    <div class="container-fluid">
      <div class="row d-flex d-md-block flex-nowrap wrapper">
        ...
        <div class="justify-content-md-center p-3 p-md-5 m-md-3 text-center">
          <h4>Lista de ingredientes disponibles en inventario</h4>
          <div class="row">
            <div class="col">
            <?php if($res->num_rows): ?>
                ...
                <?php while($row = $res->fetch_assoc()): ?>
                  <tr>
                    ...
                    <td>
                      <button id="del_st" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="bottom" title="Eliminar del sistema" value="<?php echo $row['id'] ?>">
                        <span class="oi oi-ban"></span>
                      </button>
                      <button id="upd_st" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="bottom" title="Editar datos" value="<?php echo $row['id'] ?>">
            ...
            <?php else: ?>
            	<div class="alert alert-success" role="alert">
        			  <h4 class="alert-heading">¡Registro vacio!</h4>
        			  <p>
        			  	No hay registros en la base de datos del comedor.
        			  </p>
        			</div>
            <?php endif; ?>
            </div>
